            ...
            <div class="card h-100">
              <div class="card-body p-4">
                <div class="d-flex justify-content-between">
                  ...
                  <span class="badge bg-light text-success">+12% from last month</span>
                </div>
                <div class="mt-3">
                  <h2 class="fw-bold">1,482</h2>
          ...
          <div class="col-lg-8">
            ...
            <div class="row g-4">
              <div class="col-md-4">
                <div class="card h-100">
                  <div class="position-relative">
                    <img src="https://via.placeholder.com/300x400" class="card-img-top" alt="Urban Reflections">
              ...
              <div class="col-md-4">
                <div class="card h-100">
                  <div class="position-relative">
                    <img src="https://via.placeholder.com/300x400" class="card-img-top" alt="Abstract Harmony">
                    <div class="position-absolute bottom-0 start-0 end-0 bg-dark bg-opacity-50 text-white p-2">
                      <div class="d-flex justify-content-between">
                        <div class="d-flex align-items-center">
                          <i class="bi bi-eye me-1"></i>
              ...
              <div class="col-md-4">
                <div class="card h-100">
                  <div class="position-relative">
                    <img src="https://via.placeholder.com/300x400" class="card-img-top" alt="Geometric Dreams">
                    <div class="position-absolute bottom-0 start-0 end-0 bg-dark bg-opacity-50 text-white p-2">
                      <div class="d-flex justify-content-between">
                        <div class="d-flex align-items-center">
                          <i class="bi bi-eye me-1"></i>
                  ...
                  <div class="card-body">
                    <h5 class="card-title">Geometric Dreams</h5>
                    <div class="d-flex justify-content-between align-items-center">
